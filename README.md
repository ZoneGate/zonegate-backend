...
- **Zova 1.0.0-rc2**: Embedded records, objects, and persistence layer pinned to `zova = "1.0.0-rc2"`.
...
### Zova 1.0.0-rc2 Storage Integration
- Zova 1.0.0-rc2 native embedded database (`Database.create`, `Database.open`, `Database.create_memory`) is used as the sole state and persistence engine.
